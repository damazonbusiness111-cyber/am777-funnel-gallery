...
const STAGE_LABELS = ["Verify", "Welcome", "Apply", "Sign", "Done"];
const TRACKER_INDEX: Record<Stage, number> = {
    loading: 0,
    welcome: 1,
    application: 2,
    signature: 3,
...
const fieldClass =
    "w-full rounded-lg border border-silver-soft bg-card px-3 py-2 text-[13px] text-ink placeholder:text-ink/35 outline-none transition-[border-color,box-shadow,transform] duration-200 focus-visible:border-accent focus-visible:shadow-[0_0_0_3px_rgba(59,130,246,0.2)] focus-visible:scale-[1.01]";
                      ...
                      <motion.div
                        ...
                        {!reduced && (
                                              <motion.div
                                                              ...
                                                              style={{ background: "linear-gradient(to bottom, transparent, rgba(125,180,255,0.08), transparent)" }}
                                                              animate={{ top: ["-10%", "110%"] }}
                                                              transition={{ duration: 5, repeat: Infinity, ease: "linear" }}
                                                            />
                                            )}
                                <div className="relative">
                                            <StepTracker steps={STAGE_LABELS} activeIndex={TRACKER_INDEX[stage]} />
